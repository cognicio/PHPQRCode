...
class Spec
{
    ...
    {
        if ($version < 7 || $version > Spec_VERSION_MAX)
            return 0;
    ...
    // Format information --------------------------------------------------
    // See calcFormatInfo in tests/test_Spec.c (orginal Encode c lib)
    ...
    {
        if ($version < 1 || $version > Spec_VERSION_MAX)
            return null;
